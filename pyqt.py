...
class Widget(QWidget):
    def __init__(self):
        ...
        self.table.setHorizontalHeaderLabels(["n1", "n2","n3"])
        self.table.horizontalHeader().setSectionResizeMode(QHeaderView.Interactive)
        self.table.horizontalHeader().setStretchLastSection(True)
        self.table.horizontalHeader().setDefaultSectionSize(40)
        self.table.cellChanged.connect(self.chng)
        # Chart
        ...
        self.layout.addWidget(self.table,20)
        self.layout.addLayout(self.right,80)
